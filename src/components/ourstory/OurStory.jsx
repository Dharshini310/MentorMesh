  ...
  return (
    <>
      <div className="ourstory-navbar">
        ...
        <button id="button-1">Sign In</button>
        <button id="button-2">Sign Up</button>
        </div>
      </div>
      <div>
      ...
      <div className="link">
        <ul>
            <li>Start reading<span  className="link-arrow">➡</span></li>
            <li>Satrt writing<span  className="link-arrow">➡</span></li>
        </ul>
      </div><br/>
    </>
  );
